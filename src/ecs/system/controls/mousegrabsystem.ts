...
class MouseGrabSystem extends EventHandler<EntityHoldEvent> {

    eventClasses = new Set([EntityHoldEvent])

    handleEvent(gameEvent: EntityHoldEvent): void {
...
function moveHeldEntity(gameEvent: EntityHoldEvent) {
